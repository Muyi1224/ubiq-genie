/* UltimateRadialSubButtonInfoPropertyDrawer.cs */
/* Written by Kaz */
using UnityEditor;
using UnityEngine;

[CustomPropertyDrawer( typeof( UltimateRadialSubButtonInfo ) )]
public class UltimateRadialSubButtonInfoPropertyDrawer : PropertyDrawer
{
	bool showMore = false;
	...
	public override void OnGUI ( Rect position, SerializedProperty property, GUIContent label )
	{
		...
		if( showMore )
		{
			...
			EditorGUI.PropertyField( GetNewPositionRect( position, i++ ), property.FindPropertyRelative( "key" ), new GUIContent( "Key", "The string key associated with this button." ) );
			EditorGUI.PropertyField( GetNewPositionRect( position, i++ ), property.FindPropertyRelative( "id" ), new GUIContent( "ID", "The integer ID associated with this button." ) );
			EditorGUI.PropertyField( GetNewPositionRect( position, i++ ), property.FindPropertyRelative( "name" ), new GUIContent( "Name", "The name of this button." ) );
